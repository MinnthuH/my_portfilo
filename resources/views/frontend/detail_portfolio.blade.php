    ...
    <main>
        ...
        <section class="breadcrumb__wrap">
            ...
            <div class="breadcrumb__wrap__icon">
                <ul>
                    <li><img src="{{ asset('fronted/assets/img/icons/breadcrumb_icon01.png') }}" alt=""></li>
                    <li><img src="{{ asset('fronted/assets/img/icons/breadcrumb_icon02.png') }}" alt=""></li>
                    <li><img src="{{ asset('fronted/assets/img/icons/breadcrumb_icon03.png') }}" alt=""></li>
                    <li><img src="{{ asset('fronted/assets/img/icons/breadcrumb_icon04.png') }}" alt=""></li>
                    <li><img src="{{ asset('fronted/assets/img/icons/breadcrumb_icon05.png') }}" alt=""></li>
                    <li><img src="{{ asset('fronted/assets/img/icons/breadcrumb_icon06.png') }}" alt=""></li>
                </ul>
            </div>
        </section>
        <!-- breadcrumb-area-end -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="services__details__thumb">
                            <img src="{{ asset($portfolio->portfilo_image) }}" alt="">
                        </div>
                        <div class="services__details__content">
                            <h2 class="title">{{ $portfolio->portfilo_title }}</h2>
                            <p>{!! $portfolio->portfilo_description !!}</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
