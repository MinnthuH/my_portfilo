                        ...
                        <div class="portfolio__active">
                            ...
                            <div class="portfolio__item">
                                ...
                                <div class="portfolio__overlay__content">
                                    <span>{{$item->portfilo_name}}</span>
                                    <h4 class="title"><a href="{{ route('detail#portfolio',$item->id)}}">{{$item->portfilo_title}}</a>
                                    </h4>
                                    <a href="{{ route('detail#portfolio',$item->id)}}" class="link">Case Study</a>
                                </div>
                            </div>
                            @endforeach
