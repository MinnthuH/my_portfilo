        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>I will give you Best</span>
                        <br>{{ $homeslide->title }}</h2>
                    <p class="wow fadeInUp" data-wow-delay=".4s">I'{{ $homeslide->short_title }}</p>
