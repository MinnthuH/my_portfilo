                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add About Multi Images</h4><br><br>

                            <form action="{{ route('store#multiImages') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="file" name="multiImages[]" id="image" multiple="">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
