                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{ asset('assets/images/PencilLogo.png')}}" height="30" class="logo-dark mx-auto" alt="">
                                    <img src="{{ asset('assets/images/PencilLogo.png')}}" height="30" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" id="password_confirmation" type="password" required=""  name="password_confirmation" placeholder="Comfirm Password">
                                    </div>
                                </div>
